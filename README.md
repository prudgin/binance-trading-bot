...
- collect historical data from the exchange. This is done through historical data module. Collected data is stored in a MySQL database via mysql connector python
