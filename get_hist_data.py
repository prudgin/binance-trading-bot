...
def get_candles_from_db(symbol: str, interval: str, start_ts, end_ts, limit=500, max_coroutines=50):
    ...
    last_entry_added_at = conn_db.get_latest_entry(table_name)
    ...
    _, _, count_written = conn_db.get_start_end_later_than(table_name, last_entry_added_at, only_count=True)
